            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center space-y-4">
                ...
                <div className="flex justify-center pt-12 space-x-4">
                    <button
                        ...
                        className="bg-white hover:bg-gray-300 font-bold py-2 px-6 rounded-full shadow-lg transform transition-transform hover:scale-105"
                    >
                        Bắt đầu
                    </button>
                    <button
                        onClick={() => navigate('/about-us')}
                        className="text-white font-bold py-2 px-6 transform transition-transform hover:scale-105 flex items-center space-x-2"
                    >
